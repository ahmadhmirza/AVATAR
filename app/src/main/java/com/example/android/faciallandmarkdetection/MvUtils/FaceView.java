 ...
 */
package com.example.android.faciallandmarkdetection.MvUtils;
...
public class FaceView extends View {
    ...
    private String lID = " ";
    public int numberOfLandmarks = 0;
    ...
    private void drawFaceAnnotations(Canvas canvas, double scale) {
        ...
        for (int i = 0; i < mFaces.size(); ++i) {
            ...
            for (Landmark landmark : face.getLandmarks()) {
                ...
                //Add offset for drawing the Landmark number
                cx= cx+20;
                cy= cy+10;
                drawLandmarkID();
                canvas.drawText(lID,cx,cy,text);
    ...
    private void drawLandmarkID(){
        landmarkID= landmarkID+1;
        lID = Integer.toString(landmarkID);
    }
}
